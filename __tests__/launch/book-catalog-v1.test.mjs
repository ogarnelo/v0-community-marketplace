...
test("book catalog checks local cache before Open Library and stores normalized copies", () => {
...
test("publication and editing keep manual fallback and never silently overwrite existing fields", () => {
