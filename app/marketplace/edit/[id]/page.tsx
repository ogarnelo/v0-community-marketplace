...
import { listings, categories, gradeLevels, conditions, bookFormats, bookLanguages, conditionLabels, currentSchool } from "@/lib/mock-data"
import { Loader2, ArrowLeft, HelpCircle, BookOpen, ImagePlus, X } from "lucide-react"
...
export default function EditListingPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [isDonation, setIsDonation] = useState(listing?.type === "donation")
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center bg-background">
        <div className="text-center">
          ...
          <p className="mt-2 text-muted-foreground">Este anuncio no existe o ha sido eliminado.</p>
  ...
  return (
    <div className="bg-background">
      <div className="mx-auto max-w-2xl px-4 py-6 lg:px-8">
        <Link href={`/marketplace/listing/${id}`} className="mb-4 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors">
        ...
        <Card className="border-border">
          <CardHeader>
            <CardTitle className="text-2xl text-foreground">Editar anuncio</CardTitle>
            <CardDescription>Actualiza la informacion de tu anuncio</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Textarea id="description" defaultValue={listing.description} rows={4} required />
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Select defaultValue={listing.gradeLevel} required>
                    <SelectTrigger><SelectValue /></SelectTrigger>
                    <SelectContent>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select defaultValue={listing.condition} required>
                  <SelectTrigger><SelectValue /></SelectTrigger>
                  <SelectContent>
                    {conditions.map(c => (
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      <Input id="price" type="number" min="0" step="0.5" defaultValue={listing.price} className="pr-8" required />
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      <Input id="originalPrice" type="number" min="0" step="0.5" defaultValue={listing.originalPrice} className="pr-8" />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground">&euro;</span>
                    </div>
                  </div>
                </div>
